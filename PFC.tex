...
\usepackage{xspace}
\usepackage{pgfgantt}
\usepackage[labelsep=enddash]{caption}
% pacotes adicionados
% \usepackage{amsmath}
...
\orientador{Prof. Dr. Márcio Bastos Castro}                    % Nome do orientador e
...
%%% Sobre a Banca
\numerodemembrosnabanca{1} % Isso decide se haverá uma folha adicional
