...
"pedaços" menores, denominados \textit{tiles}, entre \textit{clusters}. Essa subdivisão
...
para computar os elementos daas bordas de um \textit{tile}, é necessário obter
