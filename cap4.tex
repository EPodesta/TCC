...
a estrutura \stencil. A inicialização do processo mestre é idêntica à fase de
inicialização da versão original do \pskel, contudo o processo mestre não é responsável pela descrição do
...
finalizar a subdivisã́o dos dados, o processo mestre irá enviar os \textit{tiles}
alargados para o processo trabalhador.
