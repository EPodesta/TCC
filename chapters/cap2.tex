...
Mais precisamente, o diâmetro da rede é o número mínimo de nós que o
pacote precisa cruzar antes de chegar ao destino mais distante possível. Desta
forma, topologias $n$ dimensionais permitem que o diâmetro da rede seja maior,
utilizando mais conexões entre nós e reduzindo o atraso de comunicação.
