...
paralelas baseadas no padrão estêncil em ambientes heterogêneos CPU-GPU.
...
energético superior em relação aos processadores \textit{multicores}. O \mppa
apresenta dificuldades que podem ser solucionadas com técnicas de
\textit{tiling}, como mostrado em~\cite{lutz13}.
...
ambientes heterogêneos. Por fim, estudos sobre técnicas de \textit{tiling} se
tornam importantes na proposta apresentada, devido à capacidade limitada de
memória no \mppa.
